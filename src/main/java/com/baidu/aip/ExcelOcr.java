...
public class ExcelOcr {


    public static void main(String[] args) throws IOException {

        final String accessToken = getAuth("****", "****");
        final String request_id = requestPic("G:\\java-sdk-ocr-baidu\\src\\main\\java\\com\\baidu\\aip\\11.png",accessToken);
...
//                download download = new download();
                try {
                        download.downLoadFromUrl(url, "export.xls", "C:\\Users\\ModestYjx\\Desktop", accessToken);
